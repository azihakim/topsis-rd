						...
						<div class="row">
							<div class="col-6">
								<div class="form-group">
									...
									<input required name="nama_kriteria" type="text" class="form-control" placeholder="Masukkan Kriteria">
								</div>
							</div>
							<div class="col-6">
								<div class="form-group">
									<label>Bobot</label>
									<input required name="bobot" type="number" class="form-control" placeholder="Masukkan Bobot" min="0">
								</div>
							</div>
						</div>
